...
export default function Services() {
  const services = [
    {
      ...
      description: "Structured audit to help organizations meet NDPA and GAID requirements efficiently and correctly for UHL, EHL, and OHL classifications.",
      features: [
    ...
    },
    {
      ...
      description: "Risk-prevention tool for high-risk data processing activities under NDPA and GAID requirements.",
      features: [
    ...
    },
    {
      ...
      description: "NDPA-aligned privacy policies that are practical and reflective of real operations.",
      features: [
    ...
    },
    {
      ...
      description: "Outsourced DPO services for organizations lacking internal capacity, providing ongoing compliance oversight.",
      features: [
    ...
    },
    {
      ...
      description: "Support for NDPC classification, registration, and annual renewals to avoid penalties or suspension.",
      features: [
    ...
    },
    {
      ...
      description: "Bespoke data protection training delivered team-by-team or organization-wide over 1-3 weeks.",
      features: [
    ...
    },
    {
      ...
      description: "Ongoing compliance support through security monitoring, vulnerability detection, and remediation.",
      features: [
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
        ...
        <div className="container-responsive relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 font-display">
              Comprehensive <span className="text-gradient">Compliance Solutions</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-400 leading-relaxed">
              Expert guidance tailored to your specific regulatory, security, and governance needs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-br from-primary/10 via-[#020617] to-[#020617] relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-5" />
        ...
        <div className="container-responsive relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
              Schedule a consultation to discuss how our services can protect your organization and enable growth.
            </p>
