                ...
                <div className="container-responsive relative z-10">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-slate-400 leading-relaxed">
                            Our structured 6-week audit process ensures your
                            organization meets NDPA and GAID requirements
                                            ...
                                            <div className="grid sm:grid-cols-2 gap-3">
                                                {step.details.map(
                                                    (detail, idx) => (
                                                        <div
                                                            key={idx}
                                                            className="flex items-start gap-3 glass-panel p-3 rounded-lg"
                                                        >
                ...
                <div className="container-responsive relative z-10">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
                            Let's discuss how our proven methodology can help
                            you achieve and maintain compliance.
                        </p>
