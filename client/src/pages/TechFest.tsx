                    ...
                    <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            <div className="mb-6 sm:mb-8 overflow-hidden rounded-lg sm:rounded-2xl">
                                <img
                                    src={techFestImage}
                                    alt="Lagos Tech Fest 2026 - Cealed Associate Sponsor featuring event details: 17-18 Feb, 2026 at Lagos, Nigeria, 8AM"
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-6 backdrop-blur-sm">
                                ...
                                <p className="text-slate-300 mb-4 leading-relaxed">
                                    Now in its 6th year, Lagos Tech Fest
                                    annually gathers enterprise tech leaders,
                                    emerging startups, innovators, investors,
                                    and government representatives to shape the
                                    future of Nigeria's tech ecosystem.
                                </p>
                                <p className="text-slate-300 mb-6 leading-relaxed">
                                    Combining conferences, roundtables,
                                    exhibitions and networking, the event
                                    creates a platform that drives investments
                                    into the ecosystem.
                                </p>
                                ...
                                <div className="bg-blue-600/20 border border-blue-400/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                                    ...
                                    <p className="text-slate-300 text-xs sm:text-sm mb-2 sm:mb-3">
                                        Pick a mystery number and stand a chance
                                        to win{" "}
                                    ...
                                    {!submitted ? (
                                        <>
                                            <div className="text-center mb-6 sm:mb-8">
                                                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3 font-display whitespace-nowrap sm:whitespace-normal">
                                            ...
                                            >
                                                <input
                                                    type="hidden"
                                                    name="_subject"
                                                    value="Lagos Tech Fest 2026 - Lead"
                                                />
                                                <input
                                                    type="hidden"
                                                    name="_captcha"
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/50 transition-all"
                                                    ...
                                                    >
                                                        ...
                                                        <option
                                                            value="Privacy Programme Implementation"
                                                            className="bg-[#1e293b]"
                                                        >
                                                            Privacy Programme
                                                            Implementation
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-slate-400 text-lg mb-8">
                                                ...
                                                automatically. We'll be in touch
                                                soon!
                                            </p>
